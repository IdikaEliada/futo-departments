...
// Run `npm run codegen` from the repo root to regenerate from data/*.json
// ─────────────────────────────────────────────────────────────────────────────
...
export function listDepartmentsWithAbbreviations(): { name: Department; abbreviation: string }[] {
  return departments.map((name) => ({ name, abbreviation: departmentAbbreviations[name] }));
}
...
export function listFacultiesWithAbbreviations(): { name: Faculty; abbreviation: string }[] {
  return faculties.map((name) => ({ name, abbreviation: facultyAbbreviations[name] }));
}
